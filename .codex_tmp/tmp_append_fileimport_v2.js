const fs = require('fs');
const filePath = 'D:/codex/novel-workshop-vue3/src/services/file-import.js';
...
// Build the RTF strip regex from string to avoid escaping issues
var rtfControlRe = new RegExp('\\\\[a-z]+-?\\d*\\s?', 'g');
var rtfBraceRe = /[{}]/g;
var rtfBackslashRe = /\\\\/g;
var rtfQuoteRe = /\\'/g;
...
var code = [
  ...
  '        var text = raw.replace(' + rtfControlRe.toString() + ', "").replace(' + rtfBraceRe.toString() + ', "").replace(' + rtfBackslashRe.toString() + ', "\\").replace(' + rtfQuoteRe.toString() + ', "' + "'" + '").trim();',
...
console.log('OK: Appended 3 functions to file-import.js');
