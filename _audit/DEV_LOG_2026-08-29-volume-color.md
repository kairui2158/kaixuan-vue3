...
卷纲列表状态配色已接入全局主题令牌，问题闭环。仓库提交为 `b7db3a7`，已推送到 `origin/master`。

## 封装

- 版本：`3.5.1`
- 产物：`dist/神意助手-Setup-3.5.1.exe`
- 大小：`94,024,805` 字节（约 `89.7 MB`）
- 时间：`2026-08-29 18:36:55`
- SHA256：`1120860A90E3AAA5B9AE7FB563E8093E09ECB40CD0042762C16718FF6183CE25`
- `_audit/tmp/` 已删除，工作区在封装前保持干净。
