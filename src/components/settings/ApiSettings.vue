...
.provider-card-name { font-weight: 600; font-size: 14px; flex: 1; color: var(--text-primary); }
...
.provider-card-add-text { font-size: 13px; }
.stream-toggle { display: flex; align-items: center; gap: 6px; font-size: 12px; color: var(--text-secondary); cursor: pointer; }
.stream-toggle input { cursor: pointer; }
.config-actions { display: flex; gap: 8px; margin-bottom: 12px; }

/* === Edit View === */
.provider-edit-view { display: flex; flex-direction: column; gap: 16px; padding: 16px; background: var(--bg-card, var(--bg-elevated)); border: 1px solid var(--border-color); border-radius: 8px; }
...
.provider-edit-title-text { font-size: 15px; font-weight: 600; color: var(--text-primary); flex: 1; }
.provider-conn-status { font-size: 12px; padding: 2px 8px; border-radius: 99px; }
...
.btn-toggle { background: var(--bg-input); color: var(--text-secondary); border: 1px solid var(--border-color); border-radius: var(--radius-sm, 4px); padding: 4px 10px; font-size: 12px; cursor: pointer; white-space: nowrap; }
.btn-toggle:hover { border-color: var(--accent); color: var(--accent); }
.model-fetch-row { display: flex; gap: 8px; margin-bottom: 4px; }
.fetch-feedback { font-size: 12px; padding: 4px 0; }
